...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat7 = new Categoria(null, "Esportes");
		...
		Produto p7 = new Produto(null, "TV ture color", 1200.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "felipe.builder19@gmail.com", "33232221468", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("38844223", "998282821"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "at6226644@gmail.com", "49977060002", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("32248471", "981447526"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua das Flores", "300", "Apto 303", "Jardim", "3092000", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 303", "Centro", "2332233", cli1, c3);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Planalto", "2332233", cli2, c3);
		...
		Pagamento pagto2 = new PagamentoComBoleto(
				null, EstadoPagamento.PENDENTE, ped2, sdf.parse("27/10/2017 00:00"), null);
